...
#### 🔭 В настоящее время я работаю над двумя проектами, и участвую ещё в двух &#9874;

#### Первый проект - коммерческий проект по вёрстке сайта на WordPress (в стадии завершения).
...
Тестовой версией проекта уже пользуется целевая аудитория, проект всё еще корректируется командой.
